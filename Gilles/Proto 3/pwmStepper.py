...
#
dirPins      = [6, 11]                # GPIO direction pin
stepPins     = [7, 12]                # GPIO step pin (pwm)
enablePins   = [10, 15]                # GPIO enable pin (0=enable, 1=disable)
stepResPins  = [[9, 8], [14, 13]]    # GPIOs step resolution pins [m0,m1]
